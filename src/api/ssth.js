...
export const myWork = params => { return axios.post('/work/myWork', qs.stringify(params)).then(res => res.data) }
export const myWorkList = params => { return axios.post('/work/myWorkList', qs.stringify(params)).then(res => res.data) }
export const childWorkList = params => { return axios.post('/work/childWorkList', qs.stringify(params)).then(res => res.data) }
